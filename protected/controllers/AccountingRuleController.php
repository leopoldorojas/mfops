...
class AccountingRuleController extends Controller
{
	...
	{
		$model=new AccountingRule;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['AccountingRule']))
		{
			$model->attributes=$_POST['AccountingRule'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('AccountingRule');
	...
	{
		$model=new AccountingRule('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['AccountingRule']))
			$model->attributes=$_GET['AccountingRule'];
	...
	{
		$model=AccountingRule::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='accounting-rule-form')
		{

...
class MovementCategoryController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['MovementCategory']))
		{
			$model->attributes=$_POST['MovementCategory'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('MovementCategory');
	...
	{
		$model=new MovementCategory('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['MovementCategory']))
			$model->attributes=$_GET['MovementCategory'];
	...
	{
		$model=MovementCategory::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='movement-category-form')
		{

...
--
-- Host: localhost
-- Generation Time: Jun 10, 2013 at 12:19 PM
...
CREATE TABLE `accounting_rule` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=66 ;
...
INSERT INTO `accounting_rule` VALUES(5, 0, 13, '11000200101', '11000100101', 1, '2013-05-30 07:45:12', '0000-00-00 00:00:00', 'Paso dinero de caja 1 al banco', 0, 2);
INSERT INTO `accounting_rule` VALUES(6, 0, 14, '11000100101', '11000200101', 1, '2013-05-30 07:45:12', '0000-00-00 00:00:00', 'Paso dinero del banco a la caja 1', 1, 2);
...
INSERT INTO `document_type` VALUES(2, 'Recibo', 0, '2013-05-30 07:46:51', '0000-00-00 00:00:00', 1, 2);
...
INSERT INTO `movement_type` VALUES(67, 6, 'Pasar dinero de bancos a caja chica', 2, '2013-06-10 10:29:40', '0000-00-00 00:00:00', 0, 2);
INSERT INTO `movement_type` VALUES(68, 6, 'Pasar dinero de caja chica a bancos', 2, '2013-06-10 10:29:53', '0000-00-00 00:00:00', 0, 2);

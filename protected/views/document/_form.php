...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<tr>
		...
		<td><?php echo CHtml::activeDateField($operation,"[$i]operation_date"); ?></td>
	</tr>
	<tr>
		...
		<td><?php echo CHtml::activeTextField($operation,"[$i]entity_name"); ?></td>
		<td><?php echo CHtml::activeTextField($operation,"[$i]reference_price"); ?></td>
		<td><?php echo CHtml::activeTextArea($operation,"[$i]description"); ?></td>
	</tr>
	<tr>
		<td colspan="5"><hr /></td>
	</tr>
